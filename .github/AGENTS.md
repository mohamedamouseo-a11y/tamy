...
- Keep CI, Docker publishing, stale issue handling, release-note generation, and Tamy branding automation aligned with repository rules.
...
- This file owns release and branding automation rules; user-facing release documentation belongs under `docs/`.
...
- Keep branch, tag, release, and branding behavior synchronized between workflow YAML, source assets, tests, and user-facing documentation where applicable.
